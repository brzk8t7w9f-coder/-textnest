...
const tones=[
  {name:'Nest Bell', file:'tones/nest-bell.wav'},
  {name:'Soft Chime', file:'tones/soft-chime.wav'},
  {name:'Happy Pop', file:'tones/happy-pop.wav'},
  {name:'Classic Ring', file:'tones/classic-ring.wav'}
];
